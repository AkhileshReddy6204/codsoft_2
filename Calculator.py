...
btn_0 = Button(mw, text='0', padx=36, pady=16, font=('Arial', 14), command=lambda: btn_clk('0'))
btn_1 = Button(mw, text='1', padx=36, pady=16, font=('Arial', 14), command=lambda: btn_clk('1'))
btn_2 = Button(mw, text='2', padx=36, pady=16, font=('Arial', 14), command=lambda: btn_clk('2'))
btn_3 = Button(mw, text='3', padx=36, pady=16, font=('Arial', 14), command=lambda: btn_clk('3'))
btn_4 = Button(mw, text='4', padx=36, pady=16, font=('Arial', 14), command=lambda: btn_clk('4'))
btn_5 = Button(mw, text='5', padx=36, pady=16, font=('Arial', 14), command=lambda: btn_clk('5'))
btn_6 = Button(mw, text='6', padx=36, pady=16, font=('Arial', 14), command=lambda: btn_clk('6'))
btn_7 = Button(mw, text='7', padx=36, pady=16, font=('Arial', 14), command=lambda: btn_clk('7'))
btn_8 = Button(mw, text='8', padx=36, pady=16, font=('Arial', 14), command=lambda: btn_clk('8'))
btn_9 = Button(mw, text='9', padx=36, pady=16, font=('Arial', 14), command=lambda: btn_clk('9'))
btn_clear = Button(mw, text='clear', padx=70, pady=10, font=('Arial', 14), command=clear)
...
btn_equal = Button(mw, text='=', padx=38, pady=40, font=('Arial', 14), command=equal)
